...
public class df_CLE_API {
    ...
    public void CLE_openConnection() {
        ...
        try {
            ...
            File file = new File(env._FolderPath+stm.getFileName()+".json");
//     File dtfile = new File(env._FolderPath_Windows+stm.getFileName()+"_dataTable.json");
...
//            dtwriter.println("]}");
                    writer.println("{\"c\":[{\"v\":,\"f\":null},{\"v\":,\"\"\"f\":null}]},");
